...
<html>
	...
	<title>Lacky Singh Portfolio</title>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			<div class="text-center">
				...
				<h1 id="colorlib-logo"><a href="index.html">Lacky Singh</a></h1>
			...
			<div class="colorlib" Style="text-align: center;">
				<a href="mailto:singhlacky2001@gmail.com"><span><i class="fas fa-envelope fa-2x"></i></span></a>
				&nbsp; &nbsp;
				<a href="https://www.hackerrank.com/singhlacky2001" target="_blank"><span><i class="fab fa-hackerrank fa-2x"></i></span></a>
				&nbsp; &nbsp;
				<a href="https://stackoverflow.com/users/18346057/lacky-singh" target="_blank"><span><i class="fab fa-stack-overflow fa-2x"></i></span></a>
				&nbsp; &nbsp;
				<a href="https://github.com/ilackysingh" target="_blank"><span><i class="fab fa-github fa-2x"></i></span></a>
				&nbsp; &nbsp;
				<a href="https://www.linkedin.com/in/ilackysingh/" target="_blank"><span><i class="fab fa-linkedin fa-2x"></i></span></a>
			</div>
				   			...
				   			<div class="row">
					   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner js-fullheight">
					   					<div class="desc">
						   					<h1>Hi! <br>I'm Lacky Singh</h1>
												<p><a href="LackyResume.pdf" class="btn btn-primary btn-learn">Download CV <i class="icon-download4"></i></a></p>
											</div>
					   				</div>
					   			</div>
					   		</div>
							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
										...
										<p><strong>Hi I'm Lacky Singh</strong> I reside in Mumbai, India. 
										I am currently pursuing MCA(Master's in Computer Applications) from TIMSCDR(Thakur Institute of Management Career Development and Research), which is affliated to University of Mumbai.
										</p>
										<p>Along with my study, I also work as a freelancer at Anacky, a free-lancing expert team  on projects including website hosting and development. 
											...
											I also have a job experience of 15 month as a Server Administrator with 'Supporthives Technology LLP' where I was commited to Server Monitoring/Configuring along with hosting websites and setting up Mail Server.
										</p>
										<p>	
											I have a good knowledge on languages like Python, Java, Android, etc. However, I prefer Python as my go-to Language.
											My hobbies include Content Writing, Nature Walk, Surfing the web, etc.
											I am also an active Manager of DLLE(Department of Lifelong Learning and Extension) where we volunteer and work to make an impact on different social issues.
										</p>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
									<div class="hire">
										...
										<a href="LackyResume.pdf" class="btn-hire">Hire me</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row row-pt-md">
						<div class="col-md-4 text-center animate-box">
							<div class="services color-1">
								...
								<div class="desc">
									...
									<p>Thinking out of the box to get simpler solution</p>
								</div>
							</div>
						</div>
						<div class="col-md-4 text-center animate-box">
						...
						<div class="col-md-4 text-center animate-box">
							<div class="services color-3">
								...
								<div class="desc">
									<h3>Application</h3>
									<p>Developing Application for Android as well as iOS</p>
								</div>
							</div>
						</div>
						<div class="col-md-4 text-center animate-box">
							<div class="services color-4">
								...
								<div class="desc">
									...
									<p>Converting Repetitive Process into Automation.</p>
								</div>
							</div>
						</div>
						<div class="col-md-4 text-center animate-box">
								...
								<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
									...
									<div class="panel panel-default">
									    ...
									    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
									        <div class="panel-body">
									            <p>Sheth L.U.J. and Sir M.V. College of Science & Commerce, Mumbai</p>
													<ul>
									...
									<div class="panel panel-default">
									    ...
									    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
									        <div class="panel-body">
									            <p>Holy Family Jr. College, Mumbai</p>
													<ul>
					         ...
					         <article class="timeline-entry animate-box" data-animate-effect="fadeInLeft">
					            <div class="timeline-entry-inner">
					               ...
					               <div class="timeline-label">
					                  ...
					                  <p>Providing various services as required by the customers:</br>
											1. Website Development.</br>
											2. Hosting and Managing this domain on Live Server.</br>
						...
						<div class="col-md-5">
							<div class="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div class="colorlib-text">
									<p><a href="mailto:singhlacky2001@gmail.com">singhlacky2001@gmail.com</a></p>
								</div>
							</div>
							...
							<div class="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div class="colorlib-text">
									<p><a href="https://goo.gl/maps/VKNyfePSgdX78ecF6" target="_blank">Andheri East, Mumbai, India</a></p>
								</div>
							</div>
							...
							<div class="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div class="colorlib-text">
									<p><a href="tel://+919004051895">+91 90040 51895</a></p>
								</div>
							</div>
						</div>
